...
if __name__ == "__main__" :
	...
	result_file = "simple_N_20_results.txt"

	#size of lattice NxN
	Ns = [20]#[40, 60, 70, 80]
	
	#Temperatures to sketch out curve
	temp_list = np.array([0.5, 1.0, 1.5, 1.8, 2, 2.2, 2.4, 2.45, 2.5, 2.55, 2.6, 3.0, 3.5, 4.5])
	...
	for N in Ns :
		...
		plt.title("Heat Capacity, N =" + str(N) , size =22)
		...
		plt.title("Magnetic Susceptibility, N = " + str(N), size =22)
