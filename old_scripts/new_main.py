...
class lattice_site :
	...
	def flip_spin(self, temp, prev_dE, prev_dM, field=0, exch_energy = J_e, mag_moment = mu_e) : 
...
class lattice :
	...
	def progress(self, T, delta_Es, delta_Ss, field=0, exch_energy = J_e, mag_moment = mu_e) :
		...
		flips, dEs, dMs = v_prog(self.lattice_array, T, delta_Es, delta_Ms, field=field, exch_energy=exch_energy, mag_moment=mag_moment)
